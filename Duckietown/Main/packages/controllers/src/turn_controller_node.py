...
class TurningNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.pub_unlocklisher = rospy.Publisher(
        ...
        self.sub_turn_optionsscriber = rospy.Subscriber('~turn_options', Int32, self.set_turn_option, queue_size=1)
    ...
    def transmit_resume(self):
        ...
        message.data = True
        for _ in range(1000):
            self.pub_unlocklisher.publish(message)
